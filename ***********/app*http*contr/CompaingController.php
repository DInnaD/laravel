...
class CompaignController extends Controller
{
    ...
    public function index(Compaign $compaign, Template $template , Bunch $bunch)
    {
        //asc
       ...
       //'compaigns' -> Compaign::latest()->paginate(10);
        ...
        return view('compaign.compaigns_index', compact('compaigns', 'bunches', 'templates'));
    }
    ...
    {
        return view('compaign.compaigns_create');
    }
    ...
    public function store(Compaign $compaign, CompaignRequest $request)
    {
        ...
        return redirect()->route('compaign.compaigns_index');
    }
    ...
    {
        return view('compaign.compaigns_show', compact('compaign'));
    }
   ...
   // Compaign $compaign or id
    public function edit(Compaign $compaign)
    {
       // $data = [
        ...
        //];
        return view('compaign.compaigns_edit', compact('compaign'));
    }
