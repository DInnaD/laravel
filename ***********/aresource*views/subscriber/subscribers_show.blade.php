...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            <a class="btn btn-info btn-xs col-md-1 col-sm-2 col-xs-2" href="{{route('subscribers.subscribers_index')}}">
            ...
            <div class="col-md-2 col-sm-3 col-xs-4">
                <div class="pull-right">
                    ...
                    {{ link_to_route('subscriber.subscribers_edit', 'edit', [$subscriber->id_subscriber], ['class' => 'btn btn-primary btn-xs']) }} |
