...
@section('panel')
    <div class="panel-heading container-fluid">
        <div class="form-group">
            <a class="btn btn-info btn-xs col-md-1 col-sm-2 col-xs-2" href="{{route('bunch.bunches_index')}}">
    ...
    <div class="panel-body">
        {!! Form::model($bunch, ['route' => ['bunch.bunches_update', $bunch->id_bunch], 'method' => 'PUT']) !!}
